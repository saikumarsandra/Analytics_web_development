...
## Featured project: The Considered Market

A full ecommerce storefront (home, shop, product, cart, checkout) built in vanilla HTML/CSS/JS as a training project to sharpen Forms, Popups and Banners work — see [`ecommerce-app/`](ecommerce-app/) for details.
...
# Day3
day3 is the revision of day1  variables and day2 loops and condtions created a operational calculater that returns the result build using HTML. CSS, JS
